...
class SpectrumMixinV0_1:
    ...
    c: ClassVar[float] = c
    frequencies: ArrayLike = field(
        default=None,
        kw_only=True,
        converter=converters.optional(np.atleast_1d),
        on_setattr=[setters.convert, set_wavelengths],
    )
    wavelengths: ArrayLike = field(
        default=None,
        kw_only=True,
        converter=converters.optional(np.atleast_1d),
        on_setattr=[setters.convert, set_frequencies],
    )
...
class SpectrumMixinV0_2:
    ...
    frequencies: ArrayLike = field(
        ...
        kw_only=True,
        converter=converters.optional(np.atleast_1d),
        on_setattr=[setters.convert, unset_wavelengths],
    )
